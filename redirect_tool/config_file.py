...
"""
final_log = os.path.join(PATH,cur_date+'Redirects_Report.log')                   #final_log: PASS/FAIL info about each url
xls_report = os.path.join(PATH,cur_date+'Redirects_Report.xls')           #xls_report: PASS/FAIL info in xls format
